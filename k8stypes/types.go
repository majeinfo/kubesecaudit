...
// ReplicatSetV1 is a type alias for the v1 version of the k8s API.
type ReplicaSetV1 = appsv1.ReplicaSet

// ReplicatSetSpecV1 is a type alias for the v1 version of the k8s API.
type ReplicaSetSpecV1 = appsv1.ReplicaSetSpec
